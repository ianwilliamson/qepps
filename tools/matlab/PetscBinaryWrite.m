...
%
%
%   PetscBinaryWrite(inarg,args to write,['indices','int32' or 'int64'],['precision','float64' or 'float32'],['ispetsccomplex',true,false])
%   inarg may be:
%      filename 
...
for l=1:nargin-2
  ...
  if ischar(varargin{l}) && strcmpi(varargin{l},'ispetsccomplex')
    tnargin = min(l,tnargin-1);
