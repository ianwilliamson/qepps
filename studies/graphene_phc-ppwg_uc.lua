...
options["nev"] = 1 --This will override the -pep_nev argument for the number of eigenvalues to solve for
options["output_dir"] = os.getenv("WORK").."/data_gr3d_base_1" --Location to save solution vectors
